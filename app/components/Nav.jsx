...
var Nav = React.createClass({
  onSearch: function(e) {
    e.preventDefault();
    var location = this.refs.searchBox.value;
    ...
    return (
      <div className="top-bar">
        <div className="top-bar-left">
          <ul className="menu">
            <li className="menu-text">App Météo</li>
            <li>
        ...
        <div className="top-bar-right">
          <form onSubmit={this.onSearch}>
            <ul className="menu">
              <li>
                <input type="search" placeholder="Chercher le temps par ville" ref="searchBox"/>
              </li>
              <li>
                <input type="submit" className="button" value="Obtenir le temps"/>
              </li>
            </ul>
          </form>
        </div>
